...
public:
    ...
    bool open(const QUrl &url, const QString &ns=QString("tbim-1"));
    //TODO: close() function
    ...
    void sendMessage(const QVariantMap &value);
    void sendMessage(const QVariantList &value);
...
Q_SIGNALS:
    ...
    void JSONMessageReceived(QJsonDocument data);
...
private:
   // QWebSocket *m_pWebSocket;
    ...
    int doPostMessage(int pack_type,
    ...
    void handshakeSucceeded(QStringList protocols);
